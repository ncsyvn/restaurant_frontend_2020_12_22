    ...
    methods:
    {
        ...
        getDefaultEventDetails() {
            return {
                ...
                DiaDiem: '',
                HienThi: true,
                MauNen: this.getDefaultEventColor(),
                MauChu: '#ffffff',
                ChuTri: '',
                NoiDung: '',
                Icon: '',
                DonViThoiLuong: 'minutes'
            };
        },
        ...
        getPlaceholderEventDetails() {
            ...
            details.TieuDe = this.placeholder.noTitle;
