          ...
          <v-tab-item value="details" v-if="hasDetails">
            <v-card flat>
                <v-card-text>
                    ...
                    <!-- Description -->
                    <v-textarea hide-details single-line solo flat
                                prepend-icon="group"
                                label="Nhập thành phần tham gia"
                                v-model="details.ThanhPhan"
                                :readonly="isReadOnly"></v-textarea>
                    <!-- Calendar -->
                    <v-text-field single-line hide-details solo flat
                                  prepend-icon="gavel"
                                  lable="Nhập người chủ trì"
                                  v-model="details.ChuTri"
                                  :readonly="isReadOnly"></v-text-field>
                    <!-- Nội dung -->
                    <v-textarea single-line hide-details solo flat
                                prepend-icon="subject"
                                lable="Nhập nội dung"
                                v-model="details.NoiDung"
                                :readonly="isReadOnly"></v-textarea>
                    <!-- Color -->
                    <v-select single-line hide-details solo flat
                              prepend-icon="invert_colors"
                              :items="$dayspan.colors"
                              :color="details.MauNen"
                              :disabled="isReadOnly"
                              label="Chọn màu nền"
